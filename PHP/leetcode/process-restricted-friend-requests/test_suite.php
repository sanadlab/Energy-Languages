...
eval($__lc_src);
if (class_exists('Solution')) { $sol = new Solution(); $_ = $sol->friendRequests(20, array(1,2,3,4,5), array(1,2,3,4,5)); }
else { $_ = friendRequests(20, array(1,2,3,4,5), array(1,2,3,4,5)); }
