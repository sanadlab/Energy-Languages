...
eval($__lc_src);
if (class_exists('Solution')) { $sol = new Solution(); $_ = $sol->isRectangleOverlap(array(1,2,3,4,5), array(1,2,3,4,5)); }
else { $_ = isRectangleOverlap(array(1,2,3,4,5), array(1,2,3,4,5)); }
