...
eval($__lc_src);
if (class_exists('Solution')) { $sol = new Solution(); $_ = $sol->validateBinaryTreeNodes(20, array(1,2,3,4,5), array(1,2,3,4,5)); }
else { $_ = validateBinaryTreeNodes(20, array(1,2,3,4,5), array(1,2,3,4,5)); }
