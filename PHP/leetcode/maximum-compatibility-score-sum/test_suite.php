...
eval($__lc_src);
if (class_exists('Solution')) { $sol = new Solution(); $_ = $sol->maxCompatibilitySum(array(1,2,3,4,5), array(1,2,3,4,5)); }
else { $_ = maxCompatibilitySum(array(1,2,3,4,5), array(1,2,3,4,5)); }
